...
import org.isisaddons.wicket.summernote.cpt.applib.SummernoteApplibModule;
import org.isisaddons.wicket.summernote.fixture.SummernoteDemoFixtureModule;

/**
 * Bootstrap the application.
 */
public class SummernoteDemoAppManifest implements AppManifest {
    ...
    public List<Class<?>> getModules() {
        return Arrays.asList(
                SummernoteApplibModule.class,
                SummernoteDemoFixtureModule.class,
                SummernoteDemoAppModule.class
        );
    }
